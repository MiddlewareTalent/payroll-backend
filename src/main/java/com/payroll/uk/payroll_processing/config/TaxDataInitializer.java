...
//        }
     ...
     /*   if(taxThresholdRepository.existsByTaxYear("2025-2026")){
        ...
        try{
            if (!taxThresholdRepository.existsByTaxYear("2025-2026")) {
                initialize2025_2026TaxYear();
//                initializeNIData2025_2026TaxYear();
            }
        }
        catch (Exception e) {
...
//        }
    ...
    public List<TaxThreshold> initializeNIData2025_2026TaxYear(){
...
//        thresholds.add(createThreshold("2024-2025", TaxThreshold.TaxRegion.WALES, "NI Class 1", TaxThreshold.BandNameType.NATIONAL_INSURANCE, "12570", "50270", "8"));
//        thresholds.add(createThreshold("2024-2025", TaxThreshold.TaxRegion.WALES, "NI Class 1", TaxThreshold.BandNameType.NATIONAL_INSURANCE, "50270", null,    "2"));
        // Northern Ireland
...
//        thresholds.add(createThreshold("2024-2025", TaxThreshold.TaxRegion.NORTHERN_IRELAND, "NI Class 1", TaxThreshold.BandNameType.NATIONAL_INSURANCE, "12570", "50270", "8"));
//        thresholds.add(createThreshold("2024-2025", TaxThreshold.TaxRegion.NORTHERN_IRELAND, "NI Class 1", TaxThreshold.BandNameType.NATIONAL_INSURANCE, "50270", null,    "2"));
        taxThresholdRepository.saveAll(Collections.unmodifiableList(thresholds));
    }
}
